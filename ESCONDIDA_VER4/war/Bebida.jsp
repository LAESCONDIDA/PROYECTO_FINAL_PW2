			...
			<div class="col-md-8">
				<div class="panel panel-info">
					...
					<!-- Indica una acción exitosa o positiva -->
						<a href="Bebida.jsp"><button type="button" class="btn btn-primary btnop" value="Nuevo">NUEVO</button></a>
					<!-- Indica una acción exitosa o positiva -->
						...
						<form class="form-horizontal" role="form">
							<div id="formulario">
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="Precio" id="precio" name="precio" value=""/>
									</div>
								</div>
